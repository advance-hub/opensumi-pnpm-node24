...
async function main(): Promise<void> {
  ...
  if (!outputFile) {
    throw new Error('esbuild completed without emitting the webview preload bundle');
  }
...
/* This file is generated by scripts/bundle-webview.ts */
/* eslint-disable */
/* prettier-ignore */
...
main().catch((error: unknown) => {
  console.error('Failed to bundle the webview preload:', error);
  process.exitCode = 1;
});
